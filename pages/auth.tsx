...
//               className="bg-red-600 py-3 text-white rounded-sm w-full mt-10 hover:bg-red-700 transition"
//             >
...
//                 className="text-white mt-1 hover:underline gap-3 cursor-pointer"
//               >
//                 {variant === "login" ? "Create an account" : "Login"}
//               </span>
//               `
